...
"""
Script for managing CatBlock translations in Chrome JSON format
...
API_KEY = open(os.getcwd() + "/.crowdin_key").read()
...
req = urllib.urlopen(EXPORT_URL).read()
data = json.loads(req)
...
req = urllib.urlretrieve(DOWNLOAD_URL, "translations.zip")
